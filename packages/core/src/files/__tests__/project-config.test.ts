...
describe('ProjectConfigManager - Environment Variable Configuration', () => {
  ...
  it('should migrate version 1.2 config to 1.3', () => {
    writeFileSync(
      'rover.json',
      JSON.stringify(
        {
    ...
    // Should be migrated to version 1.3
    expect(config.version).toBe('1.3');
  ...
  it('should create config with excludePatterns', () => {
    writeFileSync(
      'rover.json',
      JSON.stringify(
        {
  ...
  it('should migrate from version 1.2 to 1.3 without excludePatterns', () => {
    writeFileSync(
      'rover.json',
      JSON.stringify(
        {
    ...
    // excludePatterns should not be present
    expect(config.excludePatterns).toBeUndefined();
