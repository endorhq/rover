 ...
 */
export type DataType = 'string' | 'number' | 'boolean' | 'list' | 'file' | 'object';

/**
 * Supported AI agent tools/providers
 */
export type AgentTool = 'claude' | 'gemini' | 'openai' | 'codex' | 'qwen';
...
export interface AgentWorkflowSchema {
    ...
    outputs: WorkflowOutput[];
    /** Default configuration when it's not specified */
    defaults: {
